import { mysqlTable, varchar, text, timestamp, boolean, decimal, int, unique, } from "drizzle-orm/mysql-core";
...
export const orderItems = mysqlTable("order_items", {
    ...
    orderProductUnique: unique("order_product_unique").on(table.orderId, table.productId),
}));
...
export const cartItems = mysqlTable("cart_items", {
    ...
    uniqueCartItem: unique("unique_cart_item").on(table.cartId, table.productId),
}));
